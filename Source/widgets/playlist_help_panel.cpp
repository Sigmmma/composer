...
//==============================================================================
PlaylistHelpPanel::PlaylistHelpPanel ()
{
    ...
    viewport->setViewedComponent (new PlaylistHelp());
...
//==============================================================================
void PlaylistHelpPanel::paint (Graphics& g)
{
...
void PlaylistHelpPanel::resized()
{
...
<JUCER_COMPONENT documentType="Component" className="PlaylistHelpPanel" componentName=""
  ...
  <VIEWPORT name="new viewport" id="8c5aa08971381218" memberName="viewport"
            ...
            hscroll="1" scrollbarThickness="10" contentType="1" jucerFile="playlist_help.cpp"
